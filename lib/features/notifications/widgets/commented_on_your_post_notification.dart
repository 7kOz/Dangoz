...
class CommentedOnYourPostNotification extends ConsumerWidget {
  String uid;
  String title;
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          return FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot notifSnapshot) {
                ...
                String postId = notifSnapshot.data['message'];
                String commentId = notifSnapshot.data['title'];
                return FutureBuilder(
                    future: ref
                        .read(notificationsControllerProvider)
                        .postData(postId),
                    builder:
                        (BuildContext context, AsyncSnapshot postSnapshot) {
