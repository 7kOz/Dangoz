...
class UploadRepostContainer extends ConsumerStatefulWidget {
  String postId;
  String posterId;
  ...
  @override
  ConsumerState<UploadRepostContainer> createState() =>
      _UploadRepostContainerState();
}

class _UploadRepostContainerState extends ConsumerState<UploadRepostContainer> {
  ...
  void saveRepostPostToDb(
    ...
    ref.read(postControllerProvider).repostAPost(
          widget.postId,
          widget.posterId,
