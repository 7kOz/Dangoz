...
import 'package:dangoz/features/auth/screens/phone_login_screen.dart';
...
class _IntroScreenState extends State<IntroScreen>
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: Get.height * 0.02),
            phoneSignIn(calculatedFourthDepth),
            SizedBox(height: Get.height * 0.02),
              ...
              children: <Widget>[
                DefaultTextStyle(
                  ...
                  child: AnimatedTextKit(
                    repeatForever: true,
                    animatedTexts: [
                      RotateAnimatedText('The Financial Network'),
                      RotateAnimatedText('Crypto'),
                      RotateAnimatedText('Stocks'),
                      RotateAnimatedText('Forex'),
                    ],
                  ),
                ),
              ],
  ...
  Widget phoneSignIn(double calculatedFourthDepth) {
    return InkWell(
      onTap: () {
        Get.to(() => const PhoneLoginScreen());
      },
      child: Material(
        elevation: calculatedFourthDepth.toInt() < 40 ? 0 : 20,
        borderRadius: BorderRadius.circular(16),
        color: Colors.transparent,
        child: ClipRRect(
          borderRadius: BorderRadius.circular(16),
          child: AnimatedContainer(
            ...
            duration: const Duration(seconds: 3),
            curve: Curves.easeIn,
            color: calculatedFourthDepth.toInt() < 40
                ? AppColors.white
                : AppColors.navy,
            child: Center(
              child: calculatedFourthDepth.toInt() < 40
                  ? const Text('')
                  : Text(
                      'Phone Sign In',
                      style: TextStyle(
