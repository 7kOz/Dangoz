...
class BearishCryptoMentions extends StatefulWidget {
  dynamic bearishSocialStatsSnapshot;
  BearishCryptoMentions({
    Key? key,
    required this.bearishSocialStatsSnapshot,
  }) : super(key: key);

  @override
  State<BearishCryptoMentions> createState() => _BearishCryptoMentionsState();
}

class _BearishCryptoMentionsState extends State<BearishCryptoMentions> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: widget.bearishSocialStatsSnapshot,
                ...
                center: Stack(
                  children: [
                    Positioned(
                      ...
                      child: Text(
                        'Bearish ${Emoji.byChar(Emojis.bear)}',
                        style: TextStyle(
                            color: AppColors.red,
