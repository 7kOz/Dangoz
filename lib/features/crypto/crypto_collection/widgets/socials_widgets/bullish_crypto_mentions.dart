...
class BullishCryptoMentions extends StatefulWidget {
  dynamic bullishSocialStatsSnapshot;
  BullishCryptoMentions({
    Key? key,
    required this.bullishSocialStatsSnapshot,
  }) : super(key: key);

  @override
  State<BullishCryptoMentions> createState() => _BullishCryptoMentionsState();
}

class _BullishCryptoMentionsState extends State<BullishCryptoMentions> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: widget.bullishSocialStatsSnapshot,
                ...
                center: Stack(
                  children: [
                    Positioned(
                      ...
                      child: Text(
                        'Bullish ${Emoji.byChar(Emojis.bison)}',
                        style: TextStyle(
